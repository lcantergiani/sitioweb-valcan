...
const i18n = {
  es: {
    ...
    // Oportunidades
    'oport.hero_label': 'Oportunidades',
    'oport.hero_title': 'Oportunidades',
    'oport.hero_subtitle': 'Locales comerciales disponibles y banco de terrenos',
    'oport.tab_locales': 'Locales Disponibles',
    'oport.tab_terrenos': 'Banco de Terrenos',
    'oport.locales_heading': 'Locales Disponibles',
    'oport.terrenos_heading': 'Banco de Terrenos',
    'oport.photo_soon': 'Foto próximamente',
    'oport.local_name': 'Local Disponible',
    'oport.terreno_name': 'Terreno Disponible',
    'oport.addr_soon': 'Dirección próximamente',
    'oport.loc_soon': 'Ubicación próximamente',
    'oport.consultar': 'Consultar',
    'oport.form_title': 'Consulta de Oportunidad',
    'oport.form_subtitle': 'Completa el formulario y te contactaremos a la brevedad.',
    'oport.ph_name': 'Nombre completo',
    'oport.ph_email': 'Email',
    'oport.ph_phone': 'Teléfono',
    'oport.ph_interest': 'Local/terreno de interés',
    'oport.ph_message': 'Mensaje',
    'oport.form_send': 'Enviar consulta',
    // Hero
    ...
    'tl.h6': 'Internacionalización del grupo',
    'tl.p6': 'El grupo expande sus operaciones a Estados Unidos, marcando el inicio de su presencia internacional',
    'tl.h7': 'Holding Diversificado',
    'tl.p7': 'Más de 40 años de trayectoria con presencia en Real Estate, Energía, Agrícola y Private Equity',
    // Premios
    'awards.label': 'Legado',
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    // Opportunities
    'oport.hero_label': 'Opportunities',
    'oport.hero_title': 'Opportunities',
    'oport.hero_subtitle': 'Available commercial spaces and land bank',
    'oport.tab_locales': 'Available Spaces',
    'oport.tab_terrenos': 'Land Bank',
    'oport.locales_heading': 'Available Spaces',
    'oport.terrenos_heading': 'Land Bank',
    'oport.photo_soon': 'Photo coming soon',
    'oport.local_name': 'Available Space',
    'oport.terreno_name': 'Available Land',
    'oport.addr_soon': 'Address coming soon',
    'oport.loc_soon': 'Location coming soon',
    'oport.consultar': 'Inquire',
    'oport.form_title': 'Opportunity Inquiry',
    'oport.form_subtitle': 'Fill out the form and we will contact you shortly.',
    'oport.ph_name': 'Full name',
    'oport.ph_email': 'Email',
    'oport.ph_phone': 'Phone',
    'oport.ph_interest': 'Space/land of interest',
    'oport.ph_message': 'Message',
    'oport.form_send': 'Send inquiry',
    // Hero
    'hero.subtitle': 'Grupo Valcan',
    ...
    'tl.h6': 'Group Internationalization',
    'tl.p6': 'The group expands its operations to the United States, marking the beginning of its international presence',
    'tl.h7': 'Diversified Holding',
    'tl.p7': 'Over 40 years of track record with presence in Real Estate, Energy, Agriculture and Private Equity',
    // Premios
    'awards.label': 'Legacy',
...
const proyectos = [
  // FILA 1 – En Desarrollo (7+5=12)
  { id: 'quilicura', nombre: 'Punto Centro Quilicura', categoria: 'retail', col: 7, row: 2, destacado: true, badges: ['EN DESARROLLO'], imagen: 'punto-centro.jpg' },
  { id: 'hilton', nombre: 'Hotel Hilton', categoria: 'hoteleria', col: 5, row: 2, destacado: true, badges: ['EN DESARROLLO'], imagen: 'hotel hilton.jpg' },
  // FILA 2 (6+6=12)
  { id: 'mapocho', nombre: 'Mapocho', categoria: 'retail', col: 6, minH: '340px', destacado: true, imagen: 'inmobiliaria-montecarlo.png', bgPos: 'center' },
  { id: 'huerfanos', nombre: 'Huérfanos', categoria: 'retail', col: 6, minH: '340px', destacado: true, imagen: 'Local huerfanos.JPG', bgPos: 'center' },
  // FILA 3 (6+6=12)
  { id: 'la-florida', nombre: 'La Florida', categoria: 'retail', col: 6, destacado: true, imagen: 'centro-comercial-la-florda.jpg' },
  { id: 'cantagallo', nombre: 'Cantagallo', categoria: 'retail', col: 6, destacado: true, imagen: 'Local Cantagallo.JPG' },
  // FILA 4 (6+6=12)
  { id: 'pajaritos', nombre: 'Pajaritos', categoria: 'retail', col: 6, destacado: true, imagen: 'Local Pajaritos.JPG' },
  { id: 'ciudad-satelite', nombre: 'Ciudad Satélite', categoria: 'retail', col: 6, destacado: true, imagen: 'Local Ciudad Satelite.JPG' },
  // FILA 5 – Residencial (3+4+2+3=12)
  ...
  { id: 'gran-santiago', nombre: 'Edificio Gran Santiago', categoria: 'residencial', col: 4, minH: '380px', destacado: true, imagen: 'edificio-gran-santiago.jpg' },
  ...
  // No destacados
  { id: 'el-alba', nombre: 'El Alba', categoria: 'retail', destacado: false, imagen: 'El Alba.jpg' },
  { id: 'la-cisterna', nombre: 'La Cisterna', categoria: 'retail', destacado: false, imagen: 'La Cisterna.jpg' },
  { id: 'alameda', nombre: 'Alameda', categoria: 'retail', destacado: false, imagen: 'Alameda.jpg' },
  { id: 'los-trapenses', nombre: 'Los Trapenses', categoria: 'retail', destacado: false, imagen: null },
  { id: 'apoquindo', nombre: 'Apoquindo', categoria: 'retail', destacado: false, imagen: 'apoquindo.jpg' },
